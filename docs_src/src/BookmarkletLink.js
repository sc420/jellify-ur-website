const bookmarklet = {
  ...
  debug:
    '(()=>{window.JELLIFY_DEBUG=1,window.JELLIFY_OPTIONS={geometry:{animationAreaZoom:1/0,translationAreaZoom:1/0}};["https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js","https://cdn.jsdelivr.net/npm/matter-js@0.17.1/build/matter.min.js","https://sc420.github.io/jellify-ur-website/js/jellify.js"].forEach(e=>{const t=document.getElementsByTagName("head")[0],a=document.createElement("script");a.src=e,t.appendChild(a)})})();',
